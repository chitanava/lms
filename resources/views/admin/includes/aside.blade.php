<aside x-data :class="{'-translate-x-[var(--nav-size)]' : !$store.aside.isOpen}" x-cloak
  ...
  <nav class="text-sm px-4 py-4 ">
    <ul>
      <li class="mb-2">
        <a href="#" class="flex px-3 py-2 items-center rounded-lg bg-purple-700 text-white"><svg class="w-4 h-4 mr-2"
      ...
      <li>
        <a href="#" class="flex px-3 py-2 hover:bg-gray-50 items-center rounded-lg"><svg class="w-4 h-4 mr-2"
            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round"
